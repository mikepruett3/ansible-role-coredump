Ansible Role: Core Dump
=========

Ansible role to configure Core Dump settings on Linux servers.
...
Role created by [mikepruett3](https://github.com/mikepruett3) on [Github.com](https://github.com/mikepruett3/ansible-role-coredump)
